 ...
 *
 * Usage:
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-roads-in.ts
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-roads-in.ts --force-download
 */
...
const MY_DATASET_ID = DATASETS_BY_KEY.get('in-national-roads')!.id
...
async function main() {
  ...
  let matchedBharatmala = 0, matchedClassDefault = 0
  let hexesUpdated = 0
