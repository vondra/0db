...
pub static PROFILES: [NpdProfile; NUM_PROFILES] = [
    ...
    NpdProfile::new(
        ...
        [96.1, 88.9, 84.3, 79.4, 71.6, 63.2, 57.1, 50.5, 43.8, 37.5],
        [114.5, 107.6, 103.0, 98.1, 90.4, 81.8, 75.7, 68.9, 61.9, 55.4],
        160.0,
        370.0,
        Installation::Wing,
    ),
    ...
    NpdProfile::new(
        ...
        [91.4, 84.4, 79.7, 74.8, 66.9, 58.2, 51.9, 45.1, 37.8, 30.6],
        [105.9, 99.1, 94.6, 89.8, 82.2, 73.9, 68.0, 61.3, 54.2, 47.1],
        160.0,
        370.0,
        Installation::Wing,
    ),
