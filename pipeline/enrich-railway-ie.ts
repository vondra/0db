 ...
 *
 * Usage:
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-ie.ts
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-ie.ts --force-download
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-ie.ts --enrich-only
 */
...
const MY_DATASET_ID = DATASETS_BY_KEY.get('ie-national-railway')!.id
