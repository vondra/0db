 ...
 *
 * Usage:
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-pt.ts
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-pt.ts --force-download
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-pt.ts --enrich-only
 */
...
const MY_DATASET_ID = DATASETS_BY_KEY.get('pt-national-railway')!.id
