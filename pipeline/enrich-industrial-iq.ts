 ...
 *
 * Usage:
 *   DATA_YEAR=2026 npx tsx pipeline/enrich-industrial-iq.ts
 */
...
// (hand-tuned EXCLUDE_ZONES bled into Iran/Kuwait/Saudi/Jordan/Syria/Turkey).
