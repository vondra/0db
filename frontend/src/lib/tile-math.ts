...
/// by the heatmap overlay, the Lden hover tooltip, and the raster cell inspector.
/// The formulas mirror the heatmap build pipeline, so a tile coordinate computed
/// in the browser indexes the exact byte the renderer painted. `z` is the tile
