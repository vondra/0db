 ...
 *
 * This gives the pipeline-worker the correct industrial noise profile:
 ...
 *
 * Usage:
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-industrial-cn.ts
 */
    ...
    try {
      ...
      for (let i = 0; i < n; i++) {
        ...
        if (best) {
          ...
          lookup[id] = { nace: naceCode, name: best.name, source: best.source }
          matched++
        }
      }
    } catch (e: any) {
      // Skip hexes with schema differences
    }
  }
