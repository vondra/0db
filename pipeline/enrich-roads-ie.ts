 ...
 *
 * Usage:
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-roads-ie.ts
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-roads-ie.ts --enrich-only
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-roads-ie.ts --force-download
 */
