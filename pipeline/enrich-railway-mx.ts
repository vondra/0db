 ...
 *
 * Usage:
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-mx.ts
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-mx.ts --force-download
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-mx.ts --enrich-only
 */
...
const MY_DATASET_ID = DATASETS_BY_KEY.get('mx-national-railway')!.id
