 ...
 *
 * Usage:
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-se.ts
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-se.ts --force-download
 *   DATA_YEAR=2025 npx tsx pipeline/enrich-railway-se.ts --enrich-only
 */
...
const MY_DATASET_ID = DATASETS_BY_KEY.get('se-national-railway')!.id
